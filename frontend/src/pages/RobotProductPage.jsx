...
const ROBOT_PRODUCTS = {
  ...
  'avidbots-neo': {
    name: 'AVIDBOTS NEO',
    tagline: 'World-Leading Autonomous Floor Scrubbing Robot',
    description: 'The AVIDBOTS NEO represents the pinnacle of autonomous commercial cleaning technology. Purpose-built from the ground up as a robot—no steering wheel, no seat, just pure autonomous intelligence. Delivering up to 42,000 square feet per hour of consistent, measurable cleaning powered by advanced AI and a comprehensive sensor suite.',
    image: '/images/bots/avidbots-neo.png',
    features: [
      'Avidbots Autonomy AI',
      '360° Real-Time Awareness',
      'Active Cleaning Control',
      'Disc or Cylindrical Heads',
      'Up to 6 Hour Runtime',
      'Auto-Adjustable Pressure',
      '42,000 ft²/hr Coverage',
      'Swappable Batteries',
      'Command Center Dashboard',
      'Self-Diagnostics',
      'Disinfection Add-On Ready',
      '24/7/365 Operation Support',
    ],
    specs: {
      'Dimensions': '152 × 76-94 × 137 cm (59.8" × 29.9-37" × 53.9")',
      'Weight': '581.5-688 kg (1,282-1,518 lbs)',
      'Cleaning Width': '24"-32" (head dependent)',
      'Max Coverage': '3,900 m²/hr (42,000 ft²/hr)',
      'Solution Tank': '109 L (28.8 gal)',
      'Recovery Tank': '135 L (35.7 gal)',
      'Battery': '6×6V AGM (36V, 220Ah)',
      'Runtime': '4-6 hours per charge',
      'Max Speed': '1.35 m/s (4.43 ft/s)',
      'Noise Level': '< 72 dBA',
      'Navigation': 'AI + LiDAR + 3D Vision',
      'Min Path Width': '76 cm (29.9 in)',
    },
    useCases: ['Airports', 'Shopping Malls', 'Hotels & Casinos', 'Hospitals', 'Universities', 'Manufacturing', 'Warehouses', 'Office Buildings'],
    highlights: [
      { title: 'Active Cleaning Control', description: 'Intelligently detects pad wear and auto-adjusts pressure for optimal floor care and consumable longevity' },
      { title: 'Around-the-Clock Operation', description: 'Six-hour runtime with fast-swap batteries enables true 24/7/365 autonomous cleaning operations' },
      { title: 'Unrivaled Performance', description: 'Cleans up to 42,000 ft²/hr without assistance—just press go and your team focuses elsewhere' },
      { title: 'Flexible Configuration', description: 'Choose disc or cylindrical cleaning heads optimized for your specific floor types and cleaning needs' },
    ],
  },
  'pudu-sh1': {
    name: 'PUDU SH1',
  ...
  'pudu-mt1-vac': {
    name: 'PUDU MT1 VAC',
    tagline: 'AI-Powered Robotic Sweeper & Vacuum',
    description: 'The PUDU MT1 VAC is a revolutionary autonomous cleaning robot that combines sweeping, vacuuming, and dust mopping in one intelligent unit. Launched in 2025, it delivers unmatched dry cleaning performance for high-traffic commercial environments with advanced AI adaptive cleaning and 24/7 operation support.',
    image: '/images/bots/pudu-mt1-vac.png',
    features: [
      'Triple-Mode Cleaning',
      'Dual-Fan Suction System',
      'H11 HEPA Filtration',
    ...
    specs: {
      'Dimensions': '840 × 600 × 490 mm (33.1 × 23.6 × 19.3 in)',
      'Weight': '75 kg (165 lbs)',
      'Vacuum Width': '55 cm (21.7 in)',
      'Total Cleaning Width': '70 cm (27.6 in) with side brushes',
      'Max Coverage': '1,400 m²/h (15,069 ft²/h)',
      'Dust Capacity': '14L dual bags',
      'Trash Bin': '6L',
      'Filtration': 'H11 HEPA-grade (98%+ capture of 0.3 µm)',
      'Battery': '45 Ah',
      'Runtime': '3-6.5 hours (4h standard)',
      'Charging Time': '<3.5 hours',
      'Speed': '0.2-1.2 m/s',
      'Navigation': 'VSLAM + LiDAR SLAM + Markers',
      'Min Path Width': '75 cm (29.5 in)',
      'Min Height Clearance': '52 cm (20.5 in)',
      'Noise Level': '<75 dB',
      'Max Climb': '20mm / 8°',
    },
    useCases: ['Airports', 'Shopping Malls', 'Hotels & Casinos', 'Metro Stations', 'Hospitals', 'Office Buildings', 'Convention Centers', 'Large Retail'],
    highlights: [
      { title: 'Triple-Mode Cleaning', description: 'Sweeps large debris, vacuums embedded dirt, and dust mops—all in one robot' },
      { title: 'Deep Suction Power', description: 'Dual independent air duct fans deliver 200% efficiency boost over traditional cleaners' },
      { title: 'HEPA Filtration', description: 'H11 HEPA-grade filtration captures 98%+ of 0.3 µm particles for dust-free operation' },
      { title: 'AI Vision Recognition', description: 'Smart spot cleaning detects trash automatically with 500% efficiency gain' },
    ],
  },
  'flashbot-max': {
    name: 'FlashBot Max',
    ...
    specs: {
      ...
      'Payload': '10 kg/layer (up to 20 kg total)',
      'Compartments': '2-4 adjustable modules',
      'Speed': '0.5-1.2 m/s',
      'Runtime': '9-12 hours',
      'Charging': '4 hours (auto-charging)',
      'Navigation': 'VSLAM + LiDAR SLAM',
      'Clearance': '60 cm path width',
      'Environment': 'Indoor/Semi-outdoor',
    },
    useCases: ['Hotels', 'Hospitals', 'Office Buildings', 'Residential Complexes', 'Restaurants', 'Corporate Campuses'],
    highlights: [
      { title: 'Multi-Floor Mastery', description: 'Autonomous elevator calling and navigation across multiple floors' },
      { title: 'Secure Access', description: 'PIN, NFC, and phone verification for contactless pickup' },
      { title: 'Adaptive Mobility', description: '6-wheel suspension handles uneven surfaces and semi-outdoor areas' },
      { title: 'Smart Ventilation', description: 'Built-in fan system maintains freshness and odor control' },
    ],
  },
  'pudu-t300': {
    name: 'PUDU T300',
    tagline: 'Industrial Delivery Powerhouse',
    description: 'The PUDU T300 revolutionizes material transport in industrial environments with its 300 kg payload capacity and intelligent autonomous operation. Purpose-built for factories, warehouses, and logistics centers, it combines advanced navigation with flexible delivery modes to streamline heavy-duty workflows.',
    ...
    specs: {
      ...
      'Weight': '60-80 kg (variant)',
      'Max Payload': '300 kg (661 lbs)',
      'Battery': '30 Ah',
      'Runtime': '6-12 hours',
      'Charging': '2 hours (0-90%)',
      'Speed': '1.2 m/s max',
      'Navigation': 'VSLAM + LiDAR SLAM',
      'Min. Path Width': '60 cm',
      'Obstacle Crossing': '20mm height, 35mm gaps',
      'Operating Temp': '0-40°C',
      'Safety': 'ISO 3691-4 compliant',
    },
    useCases: ['Factories', 'Warehouses', 'Distribution Centers', 'Manufacturing Plants', 'Logistics Hubs', 'Assembly Lines'],
    highlights: [
      { title: 'Heavy-Duty Transport', description: '300 kg capacity handles bulk materials and multi-level cargo' },
      { title: 'Flexible Modes', description: 'Auto-delivery, follow mode, power-assist, and semi-auto for diverse workflows' },
      { title: 'Rapid Setup', description: '30% faster deployment with built-in mapping technology' },
      { title: 'Modular System', description: 'Lifting, conveyor, tray, and towing variants for custom applications' },
    ],
  },
  'pudu-t600': {
    name: 'PUDU T600',
    tagline: 'Heavy-Payload Industrial Champion',
    description: 'The PUDU T600 series sets the gold standard for heavy-payload autonomous delivery with its exceptional 600 kg capacity. Designed for high-density industrial environments, it features AI-powered rack recognition, multi-floor coordination, and VDA5050 integration—delivering unmanned efficiency at scale.',
    ...
    features: [
      ...
      'VDA5050 Protocol',
      'Multi-Floor Support',
      'Autonomous Pick & Drop',
      'LiDAR + VSLAM Navigation',
      '12 Hour Runtime',
      'On-Premises Deployment',
      'Emergency Response Modes',
      'Traffic Control',
      'Low-Profile Underride Variant',
      'Fleet Coordination',
    ],
    specs: {
      'Dimensions': '960 × 500 × 1350 mm',
      'Weight': '112 kg (247 lbs)',
      'Max Payload': '600 kg (1322 lbs)',
      'Battery': '30 Ah',
      'Runtime': '12 hours (no load)',
      'Charging': '2 hours (0-90%)',
      'Speed': '0.2-1.2 m/s (adjustable)',
      'Navigation': 'LiDAR + VSLAM',
      'Min. Passability': '70 cm',
      'Surmountability': '10mm height, 35mm gap',
      'Operating Temp': '0-40°C',
      'Variants': 'Standard + Underride',
    },
    useCases: ['Warehouses', 'Manufacturing', 'Distribution Centers', 'Logistics Operations', 'Industrial Facilities', 'High-Density Storage'],
    highlights: [
      { title: 'Maximum Capacity', description: '600 kg payload reduces delivery trips and maximizes efficiency' },
      { title: 'Smart Recognition', description: 'AI identifies rack positions for autonomous pick-up and drop-off' },
      { title: 'Seamless Integration', description: 'VDA5050 protocol and on-premises deployment for secure operations' },
      { title: 'Underride Option', description: 'Low-profile variant navigates under racks and shelving systems' },
    ],
  },
};
