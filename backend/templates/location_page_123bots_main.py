...
def generate_location_page_html(
    ...
    cities = cities or []
    hero_settings = hero_settings or {}
    site_settings = site_settings or {}
    
    # Get site settings (logo, favicon, site name)
    site_logo = site_settings.get("logo_url") or logo_url
    site_favicon = site_settings.get("favicon_url") or ""
...
<head>
  ...
  <meta property="og:site_name" content="{site_name_setting}" />
      ...
      <div class="hero-content">
        ...
        <div class="hero-right">
          <div class="hero-card hero-card-clean" id="hero-card-module">
            <img src="{hero_card_image}" alt="Custom products" class="hero-card-img" id="hero-card-image"/>
            <div class="hero-card-overlay"></div>
            <div class="hero-card-content">
              <p class="hero-card-label" id="hero-card-title">{hero_card_title}</p>
              <h3 class="hero-card-title-main" id="hero-card-subtitle">{hero_card_subtitle}</h3>
              <p class="hero-card-subtitle" id="hero-card-description">{hero_card_description}</p>
            </div>
          </div>
        </div>
      </div>
